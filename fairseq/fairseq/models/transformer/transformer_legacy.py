...
@register_model_architecture("transformer", "transformer_regular")
def regular_architecture(args):
    return base_architecture(args)
...
@register_model_architecture("transformer", "transformer_mini")
def mini_architecture(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 64)
